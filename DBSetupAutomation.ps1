...
Write-Host "Stopping SQL Server and SQL Server Agent services..."
Stop-Service -Name $SQLServiceName -Force
Stop-Service -Name $AgentServiceName -Force

sc.exe config $SQLServiceName obj= $NewLogonAccount password= $NewLogonPassword

sc.exe config $AgentServiceName obj= $NewLogonAccount password= $NewLogonPassword

Set-Service -Name $AgentServiceName -StartupType Automatic

Write-Host "Starting SQL Server and SQL Server Agent services..."
...
$instances | %{
    ...
    foreach ($p in $paramArray){
        ...
        if (-not $hasFlag) {
            ...
            Set-ItemProperty -Path $regKey -Name $newRegProp -Value $p
...
if (Test-Path $RegistryPath) {
    ...
    Write-Host "The MsxEncryptChannelOptions value has been set to $NewValue."
} else {
...
GO
EXEC sp_addrolemember 'SQLAgentReaderRole', '$loginName';
GO
"@

Invoke-Sqlcmd -ConnectionString $targetConnectionString -Query $sqlQuery
...
New-Item -Path "I:\TempDB" -ItemType Directory -Force | Out-Null

# Set Permission for Disk D,G,H,I
$diskArray = @("D:", "G:", "H:","I:")
for ($i = 0; $i -lt $diskArray.Count; $i++) {
    $NewAcl = Get-Acl -Path $diskArray[$i]
    $identity = "Everyone"
    ...
    Set-Acl -Path $diskArray[$i] -AclObject $NewAcl
}

$originalSystemDBFilePath = "C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA"
$targetSystemDBFilePath = "D:\SystemDB"
$targetTempDBFilePath = "I:\TempDB"

$sqlQuery = @"
ALTER DATABASE tempdb MODIFY FILE ( NAME = tempdev , FILENAME = '$targetTempDBFilePath\tempdb.mdf' );
ALTER DATABASE tempdb MODIFY FILE ( NAME = templog , FILENAME = '$targetTempDBFilePath\templog.ldf' );
ALTER DATABASE tempdb MODIFY FILE ( NAME = temp2 , FILENAME = '$targetTempDBFilePath\tempdb_mssql_2.ndf' );
ALTER DATABASE tempdb MODIFY FILE ( NAME = temp3 , FILENAME = '$targetTempDBFilePath\tempdb_mssql_3.ndf' );
ALTER DATABASE tempdb MODIFY FILE ( NAME = temp4 , FILENAME = '$targetTempDBFilePath\tempdb_mssql_4.ndf' );
ALTER DATABASE tempdb MODIFY FILE ( NAME = temp5 , FILENAME = '$targetTempDBFilePath\tempdb_mssql_5.ndf' );
ALTER DATABASE tempdb MODIFY FILE ( NAME = temp6 , FILENAME = '$targetTempDBFilePath\tempdb_mssql_6.ndf' );
ALTER DATABASE tempdb MODIFY FILE ( NAME = temp7 , FILENAME = '$targetTempDBFilePath\tempdb_mssql_7.ndf' );
ALTER DATABASE tempdb MODIFY FILE ( NAME = temp8 , FILENAME = '$targetTempDBFilePath\tempdb_mssql_8.ndf' );

ALTER DATABASE master MODIFY FILE ( NAME = master , FILENAME = '$targetSystemDBFilePath\master.mdf' );
ALTER DATABASE master MODIFY FILE ( NAME = mastlog , FILENAME = '$targetSystemDBFilePath\mastlog.ldf' );
ALTER DATABASE model MODIFY FILE ( NAME = modeldev , FILENAME = '$targetSystemDBFilePath\model.mdf' );
ALTER DATABASE model MODIFY FILE ( NAME = modellog , FILENAME = '$targetSystemDBFilePath\modellog.ldf' );
ALTER DATABASE msdb MODIFY FILE ( NAME = MSDBData , FILENAME = '$targetSystemDBFilePath\MSDBData.mdf' );
ALTER DATABASE msdb MODIFY FILE ( NAME = MSDBLog , FILENAME = '$targetSystemDBFilePath\MSDBLog.ldf' );
"@
...
$systemDBFileNameArray = @("master.mdf", "mastlog.ldf", "model.mdf","modellog.ldf","MSDBData.mdf","MSDBLog.ldf")
$tempDBFileNameArray = @("tempdb.mdf", "templog.ldf", "tempdb_mssql_2.ndf","tempdb_mssql_3.ndf",
"tempdb_mssql_4.ndf","tempdb_mssql_5.ndf","tempdb_mssql_6.ndf","tempdb_mssql_7.ndf","tempdb_mssql_8.ndf")

for ($i = 0; $i -lt $systemDBFileNameArray.Count; $i++) {
    Move-Item -Path "$originalSystemDBFilePath\$($systemDBFileNameArray[$i])" -Destination $targetSystemDBFilePath
}

for ($i = 0; $i -lt $tempDBFileNameArray.Count; $i++) {
    Move-Item -Path "$originalSystemDBFilePath\$($tempDBFileNameArray[$i])" -Destination $targetTempDBFilePath
}

$regPath = "HKLM:\SOFTWARE\Microsoft\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQLServer\Parameters"

Set-ItemProperty -Path $regPath -Name "SQLArg0" -Value "-dD:\SystemDB\master.mdf"  # Master database file
Set-ItemProperty -Path $regPath -Name "SQLArg2" -Value "-lD:\SystemDB\mastlog.ldf" # Log file
...
/****** Object:  StoredProcedure [dbo].[sp_WhoIsActive]    Script Date: 8/20/2024 5:14:24 AM ******/
SET ANSI_NULLS ON
GO
...
USE [master]
GO
/****** Object:  Database [BKTablesDB]    Script Date: 10/06/2020 06:11:28 ******/
CREATE DATABASE [BKTablesDB] ON  PRIMARY 
( NAME = N'BKTablesDB', FILENAME = N'G:\Data\BKTablesDB.mdf' , SIZE = 448MB , MAXSIZE = UNLIMITED, FILEGROWTH = 64MB ),
( NAME = N'BKTablesDB2', FILENAME = N'G:\Data\BKTablesDB2.ndf' , SIZE = 448MB , MAXSIZE = UNLIMITED, FILEGROWTH = 64MB ),
( NAME = N'BKTablesDB3', FILENAME = N'G:\Data\BKTablesDB3.ndf' , SIZE = 448MB , MAXSIZE = UNLIMITED, FILEGROWTH = 64MB ),
( NAME = N'BKTablesDB4', FILENAME = N'G:\Data\BKTablesDB4.ndf' , SIZE = 448MB , MAXSIZE = UNLIMITED, FILEGROWTH = 64MB ),
( NAME = N'BKTablesDB5', FILENAME = N'G:\Data\BKTablesDB5.ndf' , SIZE = 448MB , MAXSIZE = UNLIMITED, FILEGROWTH = 64MB ),
( NAME = N'BKTablesDB6', FILENAME = N'G:\Data\BKTablesDB6.ndf' , SIZE = 448MB , MAXSIZE = UNLIMITED, FILEGROWTH = 64MB ),
( NAME = N'BKTablesDB7', FILENAME = N'G:\Data\BKTablesDB7.ndf' , SIZE = 448MB , MAXSIZE = UNLIMITED, FILEGROWTH = 64MB ),
( NAME = N'BKTablesDB8', FILENAME = N'G:\Data\BKTablesDB8.ndf' , SIZE = 448MB , MAXSIZE = UNLIMITED, FILEGROWTH = 64MB )
 LOG ON 
( NAME = N'BKTablesDB_log', FILENAME = N'H:\Log\BKTablesDB_log.ldf' , SIZE = 512MB , MAXSIZE = 2048GB , FILEGROWTH = 512MB )
GO
ALTER DATABASE [BKTablesDB] SET COMPATIBILITY_LEVEL = 100
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [BKTablesDB].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [BKTablesDB] SET ANSI_NULL_DEFAULT OFF
GO
ALTER DATABASE [BKTablesDB] SET ANSI_NULLS OFF
GO
ALTER DATABASE [BKTablesDB] SET ANSI_PADDING OFF
GO
ALTER DATABASE [BKTablesDB] SET ANSI_WARNINGS OFF
GO
ALTER DATABASE [BKTablesDB] SET ARITHABORT OFF
GO
ALTER DATABASE [BKTablesDB] SET AUTO_CLOSE OFF
GO
ALTER DATABASE [BKTablesDB] SET AUTO_CREATE_STATISTICS ON
GO
ALTER DATABASE [BKTablesDB] SET AUTO_SHRINK OFF
GO
ALTER DATABASE [BKTablesDB] SET AUTO_UPDATE_STATISTICS ON
GO
ALTER DATABASE [BKTablesDB] SET CURSOR_CLOSE_ON_COMMIT OFF
GO
ALTER DATABASE [BKTablesDB] SET CURSOR_DEFAULT  GLOBAL
GO
ALTER DATABASE [BKTablesDB] SET CONCAT_NULL_YIELDS_NULL OFF
GO
ALTER DATABASE [BKTablesDB] SET NUMERIC_ROUNDABORT OFF
GO
ALTER DATABASE [BKTablesDB] SET QUOTED_IDENTIFIER OFF
GO
ALTER DATABASE [BKTablesDB] SET RECURSIVE_TRIGGERS OFF
GO
ALTER DATABASE [BKTablesDB] SET  DISABLE_BROKER
GO
ALTER DATABASE [BKTablesDB] SET AUTO_UPDATE_STATISTICS_ASYNC OFF
GO
ALTER DATABASE [BKTablesDB] SET DATE_CORRELATION_OPTIMIZATION OFF
GO
ALTER DATABASE [BKTablesDB] SET TRUSTWORTHY OFF
GO
ALTER DATABASE [BKTablesDB] SET ALLOW_SNAPSHOT_ISOLATION OFF
GO
ALTER DATABASE [BKTablesDB] SET PARAMETERIZATION SIMPLE
GO
ALTER DATABASE [BKTablesDB] SET READ_COMMITTED_SNAPSHOT OFF
GO
ALTER DATABASE [BKTablesDB] SET HONOR_BROKER_PRIORITY OFF
GO
ALTER DATABASE [BKTablesDB] SET  READ_WRITE
GO
ALTER DATABASE [BKTablesDB] SET RECOVERY FULL
GO
ALTER DATABASE [BKTablesDB] SET  MULTI_USER
GO
ALTER DATABASE [BKTablesDB] SET PAGE_VERIFY CHECKSUM
GO
ALTER DATABASE [BKTablesDB] SET DB_CHAINING OFF
GO
EXEC sys.sp_db_vardecimal_storage_format N'BKTablesDB', N'ON'
GO
USE [BKTablesDB]
GO
/****** Object:  Table [dbo].[WhoIsActive]    Script Date: 10/06/2020 06:11:29 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
CREATE TABLE [dbo].[WhoIsActive](
	[dd hh:mm:ss.mss] [varchar](64) NULL,
	[dd hh:mm:ss.mss (avg)] [varchar](30) NULL,
	[session_id] [int] NULL,
	[sql_text] [xml] NULL,
	[sql_command] [xml] NULL,
	[login_name] [sysname] NULL,
	[wait_info] [nvarchar](4000) NULL,
	[tasks] [varchar](36) NULL,
	[CPU] [varchar](36) NULL,
	[tempdb_allocations] [varchar](36) NULL,
	[tempdb_current] [varchar](36) NULL,
	[blocking_session_id] [smallint] NULL,
	[blocked_session_count] [varchar](36) NULL,
	[reads] [varchar](36) NULL,
	[writes] [varchar](36) NULL,
	[context_switches] [varchar](36) NULL,
	[physical_io] [varchar](36) NULL,
	[physical_reads] [varchar](36) NULL,
	[locks] [xml] NULL,
	[used_memory] [varchar](36) NULL,
...
/****** Object:  Job [[DBA] Whoisactive_Collection]    Script Date: 4/1/2023 12:06:13 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 4/1/2023 12:06:13 PM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'[DBA] Whoisactive_Collection', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Collect Whoisactive to BKTables]    Script Date: 4/1/2023 12:06:13 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Collect Whoisactive to BKTables', 
		@step_id=1, 
...
@get_plans=0 --query_plan
,@destination_table = ''[BKTablesDB].[dbo].[WhoIsActive]''', 
		@database_name=N'master', 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Check DB Blocking]    Script Date: 4/1/2023 12:06:13 PM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Check DB Blocking', 
		@step_id=2, 
		@cmdexec_success_code=0, 
		@on_success_action=1, 
		@on_success_step_id=0, 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'TSQL', 
		@command=N'DECLARE @title nvarchar(100) = ''[Please Change to Server VM][Urgent] Query is blocking DB , please check who is active !!''
DECLARE @html VARCHAR(MAX)

SET @html = ''<table><thead><tr><th>dd hh:mm:ss.mss</th><th>session_id</th><th>sql_text</th><th>login_name</th><th>Cpu</th><th>blocked_session_count</th><th>reads</th><th>writes</th><th>used_memory</th></tr></thead><tbody>''

SELECT @html = @html + ''<tr><td>'' + ISNULL([dd hh:mm:ss.mss], '''') + ''</td><td>'' + ISNULL(CAST([session_id] AS VARCHAR(10)), '''') + ''</td><td>'' + ISNULL(CAST([sql_text] AS VARCHAR(MAX)), '''') + ''</td><td>'' + ISNULL([login_name], '''') + ''</td><td>'' + ISNULL([Cpu], '''') + ''</td><td>'' + ISNULL([blocked_session_count], ''0'') + ''</td><td>'' + ISNULL([reads], '''') + ''</td><td>'' + ISNULL([writes], '''') + ''</td><td>'' + ISNULL([used_memory], '''') + ''</td></tr>''
FROM [BKTablesDB]..[WhoIsActive]
WHERE collection_time >=  DATEADD(SECOND,-10, GETDATE()) AND blocked_session_count > 100
Select @html

SET @html = @html + ''</tbody></table>''

IF (SELECT COUNT(*) FROM [BKTablesDB]..[WhoIsActive] WHERE collection_time >=  DATEADD(SECOND,-10, GETDATE()) AND blocked_session_count > 100) > 1
BEGIN
    exec [AlertDB].[AlertDb].[dbo].[Add_Alert_2020.11.30] @title, @html
END
', 
		@database_name=N'master', 
		@flags=0
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Every15s', 
		@enabled=1, 
		@freq_type=4, 
		@freq_interval=1, 
		@freq_subday_type=2, 
		...
		@schedule_uid=N'76a6f144-ecba-4aba-9ab2-fde5e800e5cf'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
...
/****** Object:  Job [[DBA]] Delete Whoisactive HistoryData]    Script Date: 10/06/2020 05:58:06 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 10/06/2020 05:58:06 ******/
IF NOT EXISTS (SELECT name FROM msdb.dbo.syscategories WHERE name=N'[Uncategorized (Local)]' AND category_class=1)
BEGIN
EXEC @ReturnCode = msdb.dbo.sp_add_category @class=N'JOB', @type=N'LOCAL', @name=N'[Uncategorized (Local)]'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
...
DECLARE @jobId BINARY(16)
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'[DBA] Delete Whoisactive HistoryData', 
		@enabled=1, 
		@notify_level_eventlog=0, 
		@notify_level_email=0, 
		@notify_level_netsend=0, 
		...
		@owner_login_name=N'sa', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Delete History Data]    Script Date: 10/06/2020 05:58:06 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Delete History Data', 
		@step_id=1, 
		@cmdexec_success_code=0, 
		@on_success_action=1, 
		@on_success_step_id=0, 
		...
		@retry_interval=0, 
		@os_run_priority=0, @subsystem=N'TSQL', 
		@command=N'DECLARE @DELETETIME DATETIME = dateadd(DAY,-7,GETDATE())
		
Delete 	
FROM [BKTablesDB].[dbo].[WhoIsActive]
 where collection_time<=@DELETETIME', 
		@database_name=N'master', 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_update_job @job_id = @jobId, @start_step_id = 1
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Evey Day', 
		@enabled=1, 
		@freq_type=4, 
		@freq_interval=1, 
		@freq_subday_type=1, 
		...
		@active_end_time=235959, 
		@schedule_uid=N'2194298b-6c66-47e0-86f8-4ab6521d7d46'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobserver @job_id = @jobId, @server_name = N'(local)'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
COMMIT TRANSACTION
...
begin  
    ...
    select @sql='EXEC sp_addumpdevice ''disk'', '''+@dbName+'_backup'', ''D:\db_backup_full\'+@dbName+''' ;'	
    execute sp_executesql @sql
            
    select @sql='EXEC sp_addumpdevice ''disk'', '''+@dbName+'_backup_diff'', ''D:\db_backup_diff\diff_'+@dbName+''' ;'	
    execute sp_executesql @sql
    
    select @sql='EXEC sp_addumpdevice ''disk'', '''+@dbName+'_backup_log'', ''D:\db_backup_log\log_'+@dbName+''' ;'	
    execute sp_executesql @sql
